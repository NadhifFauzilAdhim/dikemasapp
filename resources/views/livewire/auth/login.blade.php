<div class="w-full max-w-md space-y-8 rounded-2xl border-2 border-amber-500/20 bg-white/90 p-8 shadow-2xl backdrop-blur-md dark:border-amber-500/10 dark:bg-slate-900/80 sm:p-10">
    <div class="text-center">
        <div class="mx-auto flex h-20 w-auto items-center justify-center">
            <img src="{{ asset('image/logo-header.png') }}" alt="Logo" class="h-16 w-auto object-contain">
        </div>
        <h2 class="mt-6 text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Dikemas Ops</h2>
